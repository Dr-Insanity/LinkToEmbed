...
def embed():
    ...
    for key, value in query.items():
        if key == '''property="twitter:image"''':
            embed += f"""<meta name="twitter:card" content="summary_large_image">\n   <meta property="twitter:image" content="{html.escape(value)}">\n   <meta property="og:image" content="{html.escape(value)}">"""
        else:
